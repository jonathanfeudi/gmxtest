...
draw_roundrect_ext(Tx+10,Ty-40+add_name,Tx+10+string_width(textbox[? "name"])+20,Ty-40+add_name+80,global.text_roundingname,global.text_roundingname,false);
...
draw_text(Tx+20,Ty-30+add_name2,textbox[? "name"]);// 30 was 50
draw_set_alpha(1);
