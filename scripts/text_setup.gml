...
{
    global.text_local_player = obj_text_control.id;
}
/*
 * Rounding of the nameplates
 */
global.text_roundingname = 15;

/*
 * Rounding of the textboxes
 */
global.text_rounding = 15;

/*
 * Set this to true to disabled box fading in and out animations
 */
global.text_boxanimation = false;
