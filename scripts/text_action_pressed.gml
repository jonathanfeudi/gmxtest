...
if (!global.text_pressed && keyboard_check_pressed(vk_up))
or (!global.text_pressed && gamepad_button_check_pressed(global.cp,gp_padu))
{
    global.text_pressed = true;
    audio_play_sound(snd_Pick_Up_Shard_Small,10,0);
